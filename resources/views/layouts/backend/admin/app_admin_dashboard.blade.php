...
<html lang="en">
  <head>
    ...
    <!-- dashboard files -->
    <title>Nursing Admin Dashboard </title>
    <!-- Styles -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Result Management<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('nursing_candidate_preview') }}">upload result</a></li>
