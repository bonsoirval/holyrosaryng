...
class CreateNursingCandidatesOlevels2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nursing_candidates_olevels2', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
      Schema::dropIfExists('nursing_candidates_olevels2');
    }
}
