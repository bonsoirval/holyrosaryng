                            ...
                            <div class="x_panel">
                                ...
                                <form id="profile" method="post" action="http://www.holyrosaryng.net/Candidate/preview/" data-parsley-validate="" class="form-horizontal form-label-left">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input name="surname" value='show gender' readonly="readonly" id="surname" class="form-control" type="text">
                 ...
                 <div class="tab-pane fade in active" id="tab1">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <form id="profile" method="POST" action="{{ route('nursing_candidate_preview_submit') }}" data-parsley-validate="" class="form-horizontal form-label-left">
                                  {{ csrf_field() }}
