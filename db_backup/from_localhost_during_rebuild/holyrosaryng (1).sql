...
--
-- Table structure for table `nursing_admin`
--

CREATE TABLE `nursing_admin` (
  `id` int(6) UNSIGNED ZEROFILL NOT NULL,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `nursing_admin`
--

INSERT INTO `nursing_admin` (`id`, `name`, `email`, `password`, `remember_token`, `phone`, `created_at`, `updated_at`) VALUES
(000001, 'NJOKU OKECHUKWU VALENTINE', 'nursing_admin@nursing_admin.nursing_admin', '$2y$10$j/eU5pxT0.AEmZb9cyDfWOrU4td/AZOZ/R/93lXLQ51YZ7Ds4A1SC', NULL, '07038616871', NULL, NULL);
...
--
-- Indexes for table `nursing_admin`
--
ALTER TABLE `nursing_admin`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nursing_candidates_email_unique` (`email`);
...
ALTER TABLE `migrations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nursing_admin`
--
ALTER TABLE `nursing_admin`
