                                ...
                                <div class="x_panel">
                                    ...
                                    <form id="profile" method='post' action="<?php echo base_url(); ?>Candidate/olevel2/2" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nationality">Examination<span>*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="examination" name="examination" class="form-control col-md-7 col-xs-12" type="text" >
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Examination Number <span>*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <?php 
                                                    $data = array(
                                         ...
                                         <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Examination Center(School)<span>*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <?php 
                                                    $data = array(
                                                        ...
                                                        'placeholder' => "Enter School Where You Wrote The Exam",
                                                        'class' => 'form-control',
                                                    );
                                                    echo form_input($data);
                                                ?>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Examination Year<span>*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <?php 
                                                    $data = array(
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="english" name="english" class="form-control col-md-7 col-xs-12" type="text" >
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="mathematics" name="mathematics" class="form-control col-md-7 col-xs-12" type="text" >
                                                    <option value="">-- Select Grade --</option>
                                                    <option value="a1">A1</option>
                                                    <option value="b2">B2</option>
                                                    <option value="b3">B3</option>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="physics"  name="physics" class="form-control col-md-7 col-xs-12" type="text" >
                                                    <option value="">-- Select Grade --</option>
                                                    <option value="a1">A1</option>
                                                    <option value="b2">B2</option>
                                                    <option value="b3">B3</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="chemistry"  name="chemistry" class="form-control col-md-7 col-xs-12" type="text" >
                                                    <option value="">-- Select Grade --</option>
                                                    <option value="a1">A1</option>
                                                    <option value="b2">B2</option>
                                                    <option value="b3">B3</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="biology" name="biology" class="form-control col-md-7 col-xs-12" type="text" >
                                                    <option value="">-- Select Grade --</option>
                                                    <option value="a1">A1</option>
                                                    <option value="b2">B2</option>
                                                    <option value="b3">B3</option>
