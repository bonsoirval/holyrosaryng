        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><!--i class="fa fa-paw"></i--> <span>School of Nursing Dashboard</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Account Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="{{ route('nursing_candidate_contact') }}">Contact</a></li>
                      <li><a href="{{ route('nursing_candidate_nextkin') }}">Next of Kin Contact</a></li>
                      <li><a href="{{ route('nursing_candidate_password_change') }}">Change Password</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Results Management<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('nursing_candidate_olevel1') }}">First Year</a></li>
                      <li><a href="{{ route('nursing_candidate_olevel1') }}">Second Year</a></li>
                      <li><a href="{{ route('nursing_candidate_olevel1') }}">Third Year</a></li>
                    </ul>
                  </li>
