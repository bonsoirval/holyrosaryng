@extends('layouts.backend.medlab.candidate.app_medlab_candidate_dashboard')
@section('content')
      <!--div class="well">
            <div class="tab-content"-->
                ...
                <div class="tab-pane fade in active" id="tab1">
                       <div  class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h1>Candidate's Olevel (First Sitting)</h1>
                                        <div class="clearfix"></div>
                                    </div>
                                    <form id="profile" method='post' action="{{ route('medlab_candidates_olevel1_submit') }}" data-parsley-validate class="form-horizontal form-label-left">
                                        {{ csrf_field() }}
