...
--
-- Host: localhost:3306
-- Generation Time: Jan 06, 2019 at 11:12 PM
...
CREATE TABLE `medlab_candidates_contacts` (
  ...
  `contact_address` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `permanent_address` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `medlab_candidates_nextkins` (
  ...
  `nextkin_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nextkin_phone` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `relationship` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `medlab_candidates_olevels1` (
  `id` int(10) UNSIGNED NOT NULL,
  `english` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `examination` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `exam_number` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `exam_year` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `mathematics` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `chemistry` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `physics` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `biology` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `medlab_candidates_profiles` (
  ...
  `gender` enum('female','male') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'female',
  ...
  `birth_town` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `lga` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `medlab_candidate_interview` (
  ...
  `user_id` smallint(5) UNSIGNED NOT NULL,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `exam_num` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_score` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_grade` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `medlab_candidate_pins` (
  ...
  `status` enum('active','used') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
...
CREATE TABLE `medlab_candidate_result` (
  ...
  `remark` enum('PASS','FAIL') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'FAIL',
  `used_card` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `nursing_admins`
--

CREATE TABLE `nursing_admins` (
  `id` int(6) UNSIGNED ZEROFILL NOT NULL,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `nursing_admins`
--

INSERT INTO `nursing_admins` (`id`, `name`, `email`, `password`, `remember_token`, `phone`, `created_at`, `updated_at`) VALUES
(000001, 'NJOKU OKECHUKWU VALENTINE', 'nursingadmin@nursingadmin.nursingadmin', '$2y$10$j/eU5pxT0.AEmZb9cyDfWOrU4td/AZOZ/R/93lXLQ51YZ7Ds4A1SC', NULL, '07038616871', NULL, NULL);
...
(000001, 'NJOKU OKECHUKWU VALENTINE', 'candidate@nursing.nursing', '$2y$10$XaE/3ajhUl5P4DVcDBf8NOxY0nihu/UskcNAmQauuwpFcqdrgM8ze', 'KqGp9GtAXngWtLZb7fNXzvt178AaJpYWzmd9l4uMW4wSmw95N5cbotE5oLGG', '07038616871', NULL, NULL);
...
(1, 1, 'dfdfsd', 'dfsdfsd', '07038616871', 'father', NULL, NULL);
...
(1, 'a1', 'waec', '111111112222222222222', 2012, 'a1', 'a1', 'a1', 'a1', 1, NULL, NULL);
...
(1, 'b2', 'waec', '111111112222222222222', 2012, 'a1', 'a1', 'a1', 'a1', 1, NULL, NULL);
...
(1, 1, '2019-01-17', 'male', '1.jpeg', 2647, 'Owerri', 'Owerri North', 160, NULL, NULL);
...
--
-- Table structure for table `nursing_mat_number`
--

CREATE TABLE `nursing_mat_number` (
  `student_id` int(6) UNSIGNED ZEROFILL NOT NULL,
  `mat_number` varchar(45) DEFAULT 'NURS2019XXXX',
  `nursing_mat_number_student_id` int(11) NOT NULL,
...
CREATE TABLE `nursing_students` (
  `id` int(6) UNSIGNED ZEROFILL NOT NULL,
  `mat_number` varchar(10) DEFAULT NULL,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `remember_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `current_year` enum('1','2','3','4') DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `nursing_students` (`id`, `mat_number`, `name`, `email`, `password`, `remember_token`, `phone`, `created_at`, `updated_at`, `current_year`) VALUES
(000009, '', 'NJOKU OKECHUKWU VALENTINE', 'student@nursing.nursing', '$2y$10$bwp2RvHbBXtFY6nnGjbuU.7ysodCWJf6ADqi/vhY1IHTSW911T4Ry', NULL, '07038616871', NULL, NULL, '1');
...
--
-- Table structure for table `nursing_student_year_one`
--

CREATE TABLE `nursing_student_year_one` (
  `id` int(10) UNSIGNED ZEROFILL NOT NULL,
  `mat_number` varchar(45) DEFAULT NULL,
  `status` enum('active','suspended','passed') DEFAULT 'active',
  `course_adviser_id` int(3) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `pts_candidate_result` (
  ...
  `user_id` smallint(5) UNSIGNED NOT NULL,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `human_biology` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `foundation_of_nursing` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `use_of_english` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `medical_jurisprudence` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `microbiology` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `physics` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `chemistry` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `behaviour_science` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `emergency_situation` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `nutrition` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `pharmacology` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `moral_ethics` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `pho` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `computer_science` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `practical` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `total` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `remark` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `position` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `exam_number` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NULL',
  `used_card` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `nursing_admins`
--
ALTER TABLE `nursing_admins`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nursing_candidates_email_unique` (`email`);
...
--
-- Indexes for table `nursing_mat_number`
--
ALTER TABLE `nursing_mat_number`
...
--
-- Indexes for table `nursing_student_year_one`
--
ALTER TABLE `nursing_student_year_one`
  ADD PRIMARY KEY (`id`,`course_adviser_id`);
...
ALTER TABLE `migrations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nursing_admins`
--
ALTER TABLE `nursing_admins`
...
ALTER TABLE `nursing_students_profiles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nursing_student_year_one`
--
ALTER TABLE `nursing_student_year_one`
...
--
-- Constraints for table `nursing_mat_number`
--
ALTER TABLE `nursing_mat_number`
  ADD CONSTRAINT `nursing_mat_number` FOREIGN KEY (`student_id`) REFERENCES `nursing_students` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `nursing_student_year_one`
--
ALTER TABLE `nursing_student_year_one`
  ADD CONSTRAINT `fk_nursing_student_year_one` FOREIGN KEY (`id`) REFERENCES `nursing_students` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
